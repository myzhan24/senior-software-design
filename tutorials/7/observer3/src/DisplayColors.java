...
public class DisplayColors{
	...
	((OriginalColorPanel) originalColorPanel).registerSlider(hueSlider);
	((OriginalColorPanel) originalColorPanel).registerSlider(saturationSlider);
	((OriginalColorPanel) originalColorPanel).registerSlider(brightnessSlider);
	...
	((ComplementaryColorPanel) complementaryColorPanel).registerPanel(originalColorPanel);
